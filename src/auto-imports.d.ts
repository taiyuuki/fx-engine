...
declare global {
  ...
  const renderer: typeof import('./stores/layers').renderer
  ...
  const useLayers: typeof import('./stores/layers').useLayers
  ...
  const useSamplerStore: typeof import('./stores/sampler').useSamplerStore
